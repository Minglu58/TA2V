...
from tav import VideoData, load_transformer
...
parser.add_argument('--save', type=str, default='./results/tav')
parser.add_argument('--data_path', type=str, default='../datasets/post_URMP/test/txt')
